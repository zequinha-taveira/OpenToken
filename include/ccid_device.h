...
// CCID Descriptor Length (Interface + Functional + 2 Endpoints)
#define TUD_CCID_DESC_LEN 77
...
#define TUD_CCID_DESCRIPTOR(_itfnum, _stridx, _epout, _epin, _bufsize)         \
  ...
  9, TUSB_DESC_INTERFACE, _itfnum, 0, 2, TUSB_CLASS_CCID, 0, 0,                \
      _stridx,                      /* CCID Functional Descriptor */           \
      ...
      U32_TO_U8S_LE(0x00020440),    /* dwFeatures: Short APDU, Automatic BAUD, \
                                       Automatic clock */                      \
      ...
      0x00,                         /* bPINSupport */                          \
      0x01, /* bMaxCCIDBusySlots */ /* Bulk OUT Endpoint */                    \
      7, TUSB_DESC_ENDPOINT, _epout, TUSB_XFER_BULK, U16_TO_U8S_LE(_bufsize),  \
      0, /* Bulk IN Endpoint */                                                \
