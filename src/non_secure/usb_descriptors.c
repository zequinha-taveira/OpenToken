...
tusb_desc_device_t const desc_device = {
    ...
    .bcdUSB = 0x0200, // USB 2.0 (Reverted for stability)
...
uint8_t const desc_bos[] = {
    ...
    0xB3, 0x00,             // wMSOSDescriptorSetTotalLength (179 bytes)
    0x02,                   // bMS_VendorCode
    0x00                    // bAltEnumCode
};
...
uint8_t const desc_ms_os_20[] = {
    ...
    0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x06, 0xB3, 0x00,

    // Configuration Subset Header: length, type, configuration index, reserved,
    // total length
    0x08, 0x00, 0x01, 0x00, 0x01, 0x00, 0xA9, 0x00,

    // Function Subset Header: length, type, first interface, reserved, subset
    // length
    0x08, 0x00, 0x02, 0x00, ITF_NUM_VENDOR, 0x00, 0xA1, 0x00,
